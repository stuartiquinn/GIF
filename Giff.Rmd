...
```{r, packInstall1, echo = T, eval = T, message = F, warning = F}
...
```{r, packInstall2, echo = T, eval = T, message = F, warning = F}
...
```{r, setConvert, echo = T, eval = F, message = F, warning = F}
...
```{r, echo=T, eval = T, warning = F, message = F, fig.align = 'center', fig.width = 9, fig.height = 7, fig.show = 'animate'}
...
```{r, renderNotes, echo = F, eval = F}
#rmarkdown::render(Giff.Rmd, output_format = 'all', clean = F)
?render()
```
